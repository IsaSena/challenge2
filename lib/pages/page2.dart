                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            child: CommonText(title: selectedUser.name, size: 16, color: Colors.white,),
                          ),
                          Container(
                            margin: const EdgeInsets.only(top: 12),
                            child: CommonText(title: selectedUser.email, size: 16, color: Colors.white,),
                          ),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          onPressed: () {
                                             ...
                                             userController.delete(selectedUser.id); //deleta o usuário pelo id passado -> poderia ser index, mudar no provider
                          ...
                          SizedBox(
                            child: IconButton(
                              ...
                              iconSize: 30,
                              onPressed: () { //usar um valueNotifier?
                  ...
                  child: SizedBox(
                    child: Column(
                      ...
                      children: [
                        ...
                        const CommonText(title: 'Anotações', size: 12,),
                        const TextFieldBox(),
                      ],
                    ),
                  ),
